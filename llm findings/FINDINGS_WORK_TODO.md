...
**Progress: 645 / 645 findings fixed.**
...
- [x] **CF-092** -- CID demux/lookup appears non-functional: the RX path uses one table, while connection creation popul
  - Severity: S0 | Sources: A | Priority: 7.0
...
- [x] **CF-161** -- `tquic_hs_cleanup` -- potential double-free of session ticket
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:2, snippet:2
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-162** -- `tquic_hs_generate_client_hello` -- output buffer `buf` not validated for minimum size
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1, lines:1
  - Missing: Code snippet proving the vulnerable pattern; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-171** -- atomic_sub on sk_rmem_alloc Incompatible with refcount_t
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:2, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-175** -- CID Lookup Returns Connection Without Reference Count
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:5, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-181** -- const-Correctness Violation in Proxy Packet Decode
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-201** -- Integer Overflow in iovec Total Length Calculation
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:2, snippet:2
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-209** -- Netfilter Short Header DCID Parsing Uses Arbitrary Length
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-221** -- Retry Packet Version Encoding Is Hardcoded for v1
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-229** -- Ticket Store Free-After-Remove Race Condition
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:2, snippet:2
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-235** -- tquic_stream_sendfile Reads Only Into First Page
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-244** -- Connection Close Reason Phrase Skipped Without Content Validation
...
- [x] **CF-245** -- Data Race in Server Migration Check
  - Severity: S1 | Sources: B | Priority: 7.0
  - Evidence: file:1, sym:1, lines:2, snippet:1
  - Missing: Kernel log / stack trace / error output demonstrating the issue; Independent confirmation from a second audit source
...
- [x] **CF-246** -- Internal Round-Robin Scheduler Missing Bounds Check
  - Severity: S1 | Sources: B | Priority: 7.0
  - Evidence: file:1, sym:2, lines:1, snippet:1
  - Missing: Kernel log / stack trace / error output demonstrating the issue; Independent confirmation from a second audit source
...
- [x] **CF-253** -- UAF-P1-02: - tquic_diag.c accesses conn->sk without reference
  - Severity: S1 | Sources: B | Priority: 7.0
...
- [x] **CF-254** -- UAF-P3-03: - Tunnel close races with connect_work and forward_work
  - Severity: S1 | Sources: B | Priority: 7.0
  - Evidence: file:1, sym:4, lines:4, snippet:1
  - Missing: Kernel log / stack trace / error output demonstrating the issue; Independent confirmation from a second audit source
...
- [x] **CF-255** -- UAF-P3-04: - Path validation timer callback accesses path after potential free
  - Severity: S1 | Sources: B | Priority: 7.0
...
- [x] **CF-256** -- UAF-P6-01: - SmartNIC ops dereference after device could be freed
  - Severity: S1 | Sources: B | Priority: 7.0
...
- [x] **CF-271** -- FEC Scheme ID Not Validated From Wire
...
- [x] **CF-279** -- Migration State Stores Raw Path Pointers Without Reference Counting
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:5, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-280** -- Missing Address Family Validation in `tquic_path_create()`
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:4, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-301** -- UAF-P1-03: - conn->sk dereference in congestion control without locking
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:2, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-302** -- UAF-P4-01: - tquic_zc_entry uses atomic_t instead of refcount_t
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:5, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-303** -- UAF-P4-02: - Paths lack reference counting entirely
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:3, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
  - Verify: `rg -n "tquic_path" "net/tquic/tquic_migration.c"`
...
- [x] **CF-306** -- Unvalidated `addr_len` Passed to `memcpy` in `tquic_connect()`
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:4, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-164** -- `tquic_hs_process_encrypted_extensions` -- ALPN validation insufficient
  - Severity: S1 | Sources: B,C | Priority: 7.0
...
- [x] **CF-185** -- EKU Semantic Mismatch: get_current_keys Returns Key, Not Secret
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:2, snippet:2
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-196** -- HIGH: Kernel address stored as u64 in buffer ring entries
  - Severity: S1 | Sources: A,B | Priority: 7.0
...
- [x] **CF-203** -- Load Balancer Has No Privilege Checks
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1
  - Missing: Exact line range(s) where the fault manifests; Code snippet proving the vulnerable pattern
...
- [x] **CF-210** -- Packet Forwarding Has No Privilege Checks
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1
  - Missing: Exact line range(s) where the fault manifests; Code snippet proving the vulnerable pattern
...
- [x] **CF-224** -- RSA Signature Algorithm Hardcoded to SHA-256 Regardless of Certificate
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Function/struct symbol name at the fault site
  - Verify: `make M=net/tquic W=1`
...
- [x] **CF-230** -- TPROXY Capability Check Logic Inversion
  - Severity: S1 | Sources: B,C | Priority: 7.0
...
- [x] **CF-239** -- Weak CID Hash Function Enables Hash Flooding
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:3, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-243** -- ACK Range Processing Without Semantic Validation
  - Severity: S1 | Sources: B | Priority: 7.0
  - Evidence: file:1, sym:4, lines:4, snippet:2
  - Missing: Kernel log / stack trace / error output demonstrating the issue; Independent confirmation from a second audit source
...
- [x] **CF-247** -- Multipath Frame Processing Lacks Encryption Level Validation
  - Severity: S1 | Sources: B | Priority: 7.0
  - Evidence: file:1, sym:1, lines:1, snippet:1
  - Missing: Kernel log / stack trace / error output demonstrating the issue; Independent confirmation from a second audit source
...
- [x] **CF-250** -- Route Lookup Fallback to init_net
  - Severity: S1 | Sources: B | Priority: 7.0
  - Evidence: file:1, sym:1, lines:2, snippet:2
  - Missing: Kernel log / stack trace / error output demonstrating the issue; Independent confirmation from a second audit source
...
- [x] **CF-266** -- BPM Path Manager Falls Back to init_net
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-267** -- CPU-5: All hash tables use `jhash` with a **fixed seed of 0**.
  - Severity: S1 | Sources: B | Priority: 4.9
...
- [x] **CF-283** -- No ACK Frame Frequency Limit Per Packet
  - Severity: S1 | Sources: B | Priority: 4.9
...
- [x] **CF-292** -- Stateless Reset Falls Back to init_net
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-158** -- `tquic_cid_pool_destroy()` Removes from rhashtable Under BH spinlock
  - Severity: S1 | Sources: B,C | Priority: 7.0
...
- [x] **CF-168** -- `tquic_recvmsg()` Same Issue as HIGH-07
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:2
  - Missing: Exact line range(s) where the fault manifests; Code snippet proving the vulnerable pattern
...
- [x] **CF-186** -- FEC decoder recovery -- partial recovery leaks on kzalloc failure
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Function/struct symbol name at the fault site
  - Verify: `make M=net/tquic W=1`
...
- [x] **CF-187** -- FEC encoder repair symbol generation -- partial resource leak on kzalloc failure
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Function/struct symbol name at the fault site
  - Verify: `make M=net/tquic W=1`
...
- [x] **CF-188** -- FEC Repair Count Computation: `block_size * target_fec_rate` Truncation
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Function/struct symbol name at the fault site
  - Verify: `make M=net/tquic W=1`
...
- [x] **CF-194** -- HIGH: atomic64_inc_return for packet number on every TX
  - Severity: S1 | Sources: A,B | Priority: 7.0
  - Evidence: file:2, sym:3, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-197** -- HIGH: kmalloc(path->mtu) per datagram send
  - Severity: S1 | Sources: A,B | Priority: 7.0
...
- [x] **CF-198** -- http3_stream.c Uses spin_lock Without _bh
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1
  - Missing: Exact line range(s) where the fault manifests; Code snippet proving the vulnerable pattern
...
- [x] **CF-199** -- Incomplete SSRF Protection in TCP-over-QUIC Tunnel
  - Severity: S1 | Sources: B,C | Priority: 7.0
...
- [x] **CF-215** -- qlog TOCTOU Race Between Length Check and copy_to_user
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Function/struct symbol name at the fault site
  - Verify: `make M=net/tquic W=1`
...
- [x] **CF-216** -- Race Condition in Idle Timer Connection Processing
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:3, snippet:2
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-222** -- Retry Token AEAD Key Set Under Non-IRQ-Safe Spinlock
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Function/struct symbol name at the fault site
  - Verify: `make M=net/tquic W=1`
...
- [x] **CF-223** -- Return Pointer to Stack/Lock-Protected Data in tquic_conn_get_active_cid
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:3, snippet:2
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
  - Verify: `rg -n "tquic_cid" "net/tquic/core/connection.c"`
...
- [x] **CF-227** -- smartnic.c Uses spin_lock Without _bh
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1
  - Missing: Exact line range(s) where the fault manifests; Code snippet proving the vulnerable pattern
...
- [x] **CF-228** -- struct tquic_napi mixes hot and cold fields
  - Severity: S1 | Sources: A,B | Priority: 7.0
...
- [x] **CF-232** -- tquic_stream_count_by_type O(n) Scan for Critical Stream Enforcement
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:2
  - Missing: Exact line range(s) where the fault manifests; Code snippet proving the vulnerable pattern
...
- [x] **CF-234** -- tquic_stream_send_allowed Missing Underflow Check
  - Severity: S1 | Sources: B,C | Priority: 7.0
...
- [x] **CF-248** -- Race Condition on path->last_activity
  - Severity: S1 | Sources: B | Priority: 7.0
...
- [x] **CF-257** -- Unlocked Connection Access in IOCTL
  - Severity: S1 | Sources: B | Priority: 7.0
  - Evidence: file:1, sym:4, lines:2, snippet:1
  - Missing: Kernel log / stack trace / error output demonstrating the issue; Independent confirmation from a second audit source
...
- [x] **CF-262** -- `tquic_nl_cmd_path_remove()` Double Put on Path
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:8, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-265** -- Bonding State Machine Missing Lock on State Transition Checks
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:4, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-268** -- Double `tquic_nl_path_put()` in `tquic_path_remove_and_free()` Assumes refcnt==2
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:8, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-272** -- Global Congestion Data Cache Without Namespace Isolation
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:2, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-274** -- h3_stream_lookup_by_push_id Linear Scan Under Lock
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:2, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-276** -- Hysteresis Counters Use Non-Atomic READ_ONCE/WRITE_ONCE Without Lock
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:3, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-285** -- Path Validation Timeout Accesses Path State Without Lock After Unlock
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-289** -- sched/scheduler.c rr_select TOCTOU on num_paths
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Function/struct symbol name at the fault site
  - Verify: `make M=net/tquic W=1`
...
- [x] **CF-294** -- TOCTOU Race in Bonding State Transition
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:2, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-297** -- tquic_stream_check_flow_control TOCTOU with sendmsg
  - Severity: S1 | Sources: B | Priority: 4.9
...
- [x] **CF-298** -- tquic_stream_ext Uses GFP_ATOMIC for Large Allocation
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-305** -- Unprotected Global Loss Tracker Array
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:2, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-159** -- `tquic_conn_retire_cid()` Does Not Remove CID from Lookup Hash Table
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:2
  - Missing: Exact line range(s) where the fault manifests; Code snippet proving the vulnerable pattern
...
- [x] **CF-167** -- `tquic_hs_setup_psk` -- integer overflow in ticket age calculation
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
  - Verify: `rg -n "tquic_hs_setup_psk" "net/tquic/crypto/handshake.c"`
...
- [x] **CF-170** -- Anti-Amplification Integer Overflow
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Function/struct symbol name at the fault site
  - Verify: `make M=net/tquic W=1`
...
- [x] **CF-172** -- BBRv2 Inflight Calculation Truncation
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, snippet:2
  - Missing: Exact line range(s) where the fault manifests; Function/struct symbol name at the fault site
  - Verify: `make M=net/tquic W=1`
...
- [x] **CF-176** -- Coalesced Packet Splitting Assumes v1 Packet Type Encoding
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1, snippet:2
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-189** -- FEC Scheduler Loss Rate Overflow
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, snippet:2
  - Missing: Exact line range(s) where the fault manifests; Function/struct symbol name at the fault site
  - Verify: `make M=net/tquic W=1`
...
- [x] **CF-193** -- h3_control_recv_frame Does Not Parse Frame Payloads
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-207** -- Missing Validation of `first_ack_range` Against `largest_ack`
  - Severity: S1 | Sources: B,C | Priority: 7.0
...
- [x] **CF-208** -- Missing Validation of `TQUIC_MIGRATE` sockopt Address
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:5, snippet:2
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-212** -- Prague Congestion Control: `ecn_ce_count * mss` Overflow
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, snippet:2
  - Missing: Exact line range(s) where the fault manifests; Function/struct symbol name at the fault site
  - Verify: `make M=net/tquic W=1`
...
- [x] **CF-214** -- PTO Duration Exponential Shift Overflow
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1, snippet:2
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-238** -- Version Negotiation Packet Missing Randomized First Byte
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1
  - Missing: Exact line range(s) where the fault manifests; Code snippet proving the vulnerable pattern
...
- [x] **CF-241** -- `tquic_connect()` Stores Error in `sk->sk_err` as Positive Value Wrongly
  - Severity: S1 | Sources: B | Priority: 7.0
  - Evidence: file:1, sym:2, lines:1, snippet:1
  - Missing: Kernel log / stack trace / error output demonstrating the issue; Independent confirmation from a second audit source
  - Verify: `rg -n "tquic_connect" "net/tquic/tquic_socket.c"`
...
- [x] **CF-242** -- ACK Frame bytes_acked Calculation Can Overflow
  - Severity: S1 | Sources: B | Priority: 7.0
  - Evidence: file:1, sym:1, lines:1, snippet:1
  - Missing: Kernel log / stack trace / error output demonstrating the issue; Independent confirmation from a second audit source
...
- [x] **CF-249** -- Retire Prior To Not Validated Against Sequence Number
  - Severity: S1 | Sources: B | Priority: 7.0
...
- [x] **CF-251** -- tquic_output_packet Passes NULL conn to ip_local_out
  - Severity: S1 | Sources: B | Priority: 7.0
...
- [x] **CF-269** -- Expensive Operation in Loss Path
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:2, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-270** -- Failover Retransmit Queue Can Exceed Memory Limits
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-286** -- qpack_encoder known_received_count Overflow via Insert Count Increment
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-287** -- Repair Frame Field Truncation Without Validation
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:1, snippet:2
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-295** -- TQUIC_MAX_PATHS Mismatch
  - Severity: S1 | Sources: B | Priority: 4.9
...
- [x] **CF-299** -- tquic_udp_recv Processes Stateless Reset Before Authenticating Packet
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:1, lines:1
  - Missing: Code snippet proving the vulnerable pattern; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-307** -- Weight Accumulation Without Overflow Check
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:2, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-182** -- copy_from_user with User-Controlled Size in Socket Options
  - Severity: S1 | Sources: B,C | Priority: 7.0
  - Evidence: file:1, sym:1, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
  - Verify: `rg -n "tquic_socket" "net/quic/tquic/tquic_socket.c"`
...
- [x] **CF-252** -- Type Shadowing Creates Memory Corruption Risk
  - Severity: S1 | Sources: B | Priority: 7.0
...
- [x] **CF-284** -- Path Manager Uses init_net Instead of Per-Connection Net Namespace
  - Severity: S1 | Sources: B | Priority: 4.9
  - Evidence: file:1, sym:2, snippet:1
  - Missing: Exact line range(s) where the fault manifests; Kernel log / stack trace / error output demonstrating the issue
...
- [x] **CF-316** -- Missing Bounds Check on tbs Pointer in Signature Parse
  - S2 | A,B,C | Evidence: file:1, sym:4

- [x] **CF-318** -- Path Score Computation Can Overflow in Migration Target Selection
  - S2 | A,B,C | Evidence: file:1, sym:4, snippet:1

- [x] **CF-323** -- QPACK Encoder/Decoder: Excessive Stack Usage
  - S2 | A,B,C | Evidence: file:2, sym:5

- [x] **CF-325** -- QPACK Integer Decode: Shift Overflow
  - S2 | A,B,C | Evidence: file:1, sym:1

- [x] **CF-348** -- `tquic_proc.c` Buffer Overflow in Hex CID Formatting
  - S2 | B,C | Evidence: file:1, sym:2, lines:3, snippet:2

- [x] **CF-352** -- `transport_params.c` Memcpy with `count * sizeof(u32)` Without Overflow Check
  - S2 | B,C | Evidence: file:1, lines:1, snippet:1

- [x] **CF-372** -- FEC encoder allocates per-symbol in GFP_ATOMIC
  - S2 | A,B | Evidence: file:2, lines:1, snippet:1

- [x] **CF-438** -- Zerocopy entry refcount uses atomic_t
  - S2 | A,B | Evidence: file:2, sym:4, lines:1, snippet:1

- [x] **CF-510** -- Netlink Family Exported as EXPORT_SYMBOL_GPL
  - S3 | A,B,C | Evidence: file:1, sym:2, snippet:1

#### Security (24)

- [x] **CF-309** -- Bloom Filter False Negatives Allow Replay
  - S2 | A,B,C | Evidence: file:1, sym:2

- [x] **CF-310** -- Decoy Packet Size Calculation Can Underflow
  - S2 | A,B,C | Evidence: file:1, sym:4, snippet:2

- [x] **CF-312** -- HP Key Rotation Swaps Old Keys Without Zeroization
  - S2 | A,B,C | Evidence: file:1, sym:2, snippet:2

- [x] **CF-313** -- HTTP/3 Connection: O(n) Push Entry Counting
  - S2 | A,B,C | Evidence: file:1, sym:1

- [x] **CF-314** -- HTTP/3 Frame Parsing: 16MB Maximum Frame Payload
  - S2 | A,B,C | Evidence: file:1, sym:1

- [x] **CF-319** -- Per-Call crypto_alloc_shash in Stateless Reset Token Generation
  - S2 | A,B,C | Evidence: file:1, sym:2

- [x] **CF-320** -- QAT Encrypt Sets Key on Every Call
  - S2 | A,B,C | Evidence: file:1, sym:2

- [x] **CF-324** -- QPACK Huffman Decoder: O(n*256) Complexity
  - S2 | A,B,C | Evidence: file:1, sym:1

- [x] **CF-326** -- Time Parsing Does Not Validate Digit Characters
  - S2 | A,B,C | Evidence: file:1, sym:3

- [x] **CF-327** -- Transcript Buffer Not Zeroized Before Free
  - S2 | A,B,C | Evidence: file:1, sym:4

- [x] **CF-361** -- Certificate Chain Parsing Does Not Verify Issuer-Subject Linkage Before Trust Check
  - S2 | B,C | Evidence: file:1, lines:1, snippet:1

- [x] **CF-383** -- Key Material Not Zeroized on All Error Paths in tquic_zero_rtt_derive_keys
  - S2 | B,C | Evidence: file:1, sym:1, lines:2, snippet:1

- [x] **CF-421** -- Sysctl and Proc Entries Registered in init_net Only
  - S2 | B,C | Evidence: file:4, sym:2, lines:3, snippet:1

- [x] **CF-502** -- Certificate Chain Length Limit Checked Late
  - S3 | A,B,C | Evidence: file:17, sym:11

- [x] **CF-503** -- Duplicate MODULE_DESCRIPTION in quic_exfil.c
  - S3 | A,B,C | Evidence: file:1, sym:6, lines:1, snippet:1

- [x] **CF-507** -- Load Balancer Stack Buffers for Feistel Not Zeroized on Error
  - S3 | A,B,C | Evidence: file:1, sym:3

- [x] **CF-508** -- Module Parameters Expose Security Configuration
  - S3 | A,B,C | Evidence: file:1, sym:3

- [x] **CF-511** -- Per-CPU Stats Not Protected Against Torn Reads on 32-bit
  - S3 | A,B,C | Evidence: file:1, sym:2

- [x] **CF-512** -- Procfs trusted_cas File Writable Without Capability Check
  - S3 | A,B,C | Evidence: file:1, sym:4

- [x] **CF-514** -- Unused HKDF-Expand Output in Extended Key Update
  - S3 | A,B,C | Evidence: file:1, sym:1

- [x] **CF-515** -- Volatile Qualifiers in Constant-Time Functions May Be Insufficient
  - S3 | A,B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-538** -- crypto_wait_req May Sleep in Encrypt/Decrypt Hot Path
  - S3 | B,C | Evidence: file:1, lines:2, snippet:1

- [x] **CF-551** -- Multipath Nonce Construction -- Potential Nonce Reuse Across Paths
  - S3 | B,C | Evidence: file:1, sym:3, lines:5, snippet:1

- [x] **CF-553** -- Netlink Operations All Require GENL_ADMIN_PERM
  - S3 | B,C | Evidence: file:1, sym:2, lines:1, snippet:2

#### Concurrency (17)

- [x] **CF-311** -- EKU Request ID Increment Outside Lock
  - S2 | A,B,C | Evidence: file:1, sym:1, lines:2

- [x] **CF-315** -- HTTP/3 Settings Parser: TOCTOU on Settings Count
  - S2 | A,B,C | Evidence: file:1, sym:1

- [x] **CF-321** -- Qlog Ring Buffer: Not Truly Lock-Free
  - S2 | A,B,C | Evidence: file:1, sym:1

- [x] **CF-362** -- CID Sequence Number Rollback on rhashtable Insert Failure
  - S2 | B,C | Evidence: file:1, lines:1, snippet:1

- [x] **CF-363** -- conn->streams_lock for RB-tree walk on every STREAM frame
  - S2 | A,B | Evidence: file:2, sym:4, lines:1, snippet:1

- [x] **CF-367** -- Coupled Congestion Control Division by Zero
  - S2 | B,C | Evidence: file:1, lines:2, snippet:1

- [x] **CF-370** -- Error Ring Uses Atomics Under Spinlock Unnecessarily
  - S2 | B,C | Evidence: file:1, sym:1, lines:1, snippet:1

- [x] **CF-373** -- FEC encoder double lock nesting
  - S2 | A,B | Evidence: file:2, sym:4, lines:1, snippet:1

- [x] **CF-374** -- FEC Encoder Triple-Nested Locking
  - S2 | B,C | Evidence: file:1, lines:1, snippet:2

- [x] **CF-400** -- Pacing work function drops and reacquires lock per packet
  - S2 | A,B | Evidence: file:2, sym:5, lines:1, snippet:1

- [x] **CF-404** -- Per-Call skcipher_request Allocation in HP Mask Hot Path
  - S2 | B,C | Evidence: file:1, sym:1, lines:2, snippet:1

- [x] **CF-405** -- Per-Packet kmalloc in Batch Encrypt/Decrypt
  - S2 | B,C | Evidence: file:1, lines:2, snippet:1

- [x] **CF-410** -- rcu_dereference Outside Explicit RCU Section
  - S2 | B,C | Evidence: file:1, sym:3, lines:1, snippet:2

- [x] **CF-417** -- SmartNIC offload takes dev->lock for every key operation
  - S2 | A,B | Evidence: file:2, sym:3, lines:1, snippet:1

- [x] **CF-506** -- Key Update Timeout Revert Could Race With Concurrent Update
  - S3 | A,B,C | Evidence: file:1, sym:2

- [x] **CF-513** -- Qlog: Lock Drop Around copy_to_user
  - S3 | A,B,C | Evidence: file:1, sym:2

- [x] **CF-558** -- Redundant Lock in tquic_bonding_get_state
  - S3 | B,C | Evidence: file:1, sym:2, lines:2, snippet:1

#### Correctness (7)

- [x] **CF-328** -- Tunnel Port Allocation Unsigned Underflow
  - S2 | A,B,C | Evidence: file:1, sym:3, snippet:1

- [x] **CF-353** -- ACK Frame Range Count Uses u64 Loop Variable Against size_t max_ranges
  - S2 | B,C | Evidence: file:1, lines:1, snippet:1

- [x] **CF-409** -- PSK Identity Logged with `tquic_dbg()` -- Sensitive Data in Kernel Logs
  - S2 | B,C | Evidence: file:1, sym:2, lines:1, snippet:2

- [x] **CF-427** -- tquic_conn_create -- loss_detection_init failure doesn't clean up timers
  - S2 | B,C | Evidence: file:1, sym:2, lines:2, snippet:1

- [x] **CF-504** -- Duplicate Static Functions: h3_varint_encode/decode
  - S3 | A,B,C | Evidence: file:2, sym:3

- [x] **CF-564** -- Stream ID Right-Shift Comparison
  - S3 | B,C | Evidence: file:1, sym:1, lines:1, snippet:1

- [x] **CF-566** -- tquic_ipv6.c MTU Info getsockopt
  - S3 | B,C | Evidence: file:1, sym:2, lines:5, snippet:1

#### Api (2)

- [x] **CF-322** -- Qlog: JSON Strings Not Escaped
  - S2 | A,B,C | Evidence: file:1, sym:2

- [x] **CF-351** -- `tquic_sock_setsockopt()` Reads `int` for Some Options But Accepts `optlen >= sizeof(int)` Without C
  - S2 | B,C | Evidence: file:1, sym:4, lines:5, snippet:2

#### Perf (1)

- [x] **CF-501** -- Batch Crypto Allocates Per-Packet Temporary Buffer
  - S3 | A,B,C | Evidence: file:1, sym:1
...
- [x] **CF-317** -- Path Metrics Subscription: Timer/Connection Lifetime Race
  - S2 | A,B,C | Evidence: file:1, sym:2

- [x] **CF-332** -- `hs_varint_encode` -- no bounds check on output buffer
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-341** -- `tquic_hs_process_certificate_verify` -- `content[200]` stack buffer could overflow with large hash
  - S2 | B,C | Evidence: file:1, sym:1, snippet:2

- [x] **CF-342** -- `tquic_hs_process_certificate` -- unbounded certificate allocation
  - S2 | B,C | Evidence: file:1, sym:1, snippet:2

- [x] **CF-371** -- Exfil Context set_level Destroys and Reinitializes Without Lock
  - S2 | B,C | Evidence: file:1, sym:3, snippet:1

- [x] **CF-385** -- Load Balancer Feistel Network Half-Length Overlap
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-392** -- Missing Bounds Check on tquic_hyst_state_names Array Access
  - S2 | B,C | Evidence: file:1, sym:3, snippet:1

- [x] **CF-396** -- Netlink Path Dump Reads conn_id on Every Iteration
  - S2 | B,C | Evidence: file:1, sym:3, snippet:1

- [x] **CF-413** -- SAN DNS Names Not Validated for Embedded NUL Characters
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-449** -- TQUIC_PSK_IDENTITY Off-by-One Potential
  - S2 | B | Evidence: file:1, lines:2, snippet:1

- [x] **CF-452** -- UAF-P5-02: - Path list uses RCU but active_path does not
  - S2 | B | Evidence: file:1, sym:4, lines:1, snippet:1

- [x] **CF-470** -- HMAC Stack Buffer Size
  - S2 | B | Evidence: file:1, sym:1, snippet:1

- [x] **CF-491** -- UAF-ADD-01: - tquic_tunnel_close does not cancel forward_work for tproxy tunnels
  - S2 | B | Evidence: file:1, sym:3, lines:1

- [x] **CF-492** -- UAF-P3-05: - GRO flush_timer can fire after kfree
  - S2 | B | Evidence: file:1, sym:3, snippet:1

- [x] **CF-493** -- UAF-P4-03: - Double destruction path for connections
  - S2 | B | Evidence: file:2, sym:6, lines:3

- [x] **CF-494** -- UAF-P5-01: - Correct RCU usage in tquic_nf.c
  - S2 | B | Evidence: file:1, sym:5, snippet:1

- [x] **CF-495** -- UAF-P6-02: - tquic_zerocopy_complete callback chain
  - S2 | B | Evidence: file:1, sym:4, snippet:1

- [x] **CF-531** -- Benchmark Code: Userspace, Not Kernel
  - S3 | A,B | Evidence: file:2, sym:12

- [x] **CF-548** -- Minimal tracepoint overhead
  - S3 | A,B | Evidence: file:1, sym:7

- [x] **CF-559** -- Retry Integrity Tag Computed with Potentially-Failing AEAD
  - S3 | B,C | Evidence: file:1, snippet:1

- [x] **CF-576** -- Version Negotiation Response - dcid/scid_len Not Capped
  - S3 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-584** -- UAF-ADD-02: - CID pool rotation_work vs pool destruction race window
  - S3 | B | Evidence: file:1, sym:1, lines:5, snippet:1

#### Security (43)

- [x] **CF-335** -- `ring_index()` Uses Unbounded While Loop
  - S2 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-339** -- `tquic_hs_derive_early_secrets` -- `memzero_explicit` called before error check
  - S2 | B,C | Evidence: file:1, sym:2, snippet:1

- [x] **CF-340** -- `tquic_hs_generate_client_hello` -- `hkdf_label` stack buffer on sensitive crypto path
  - S2 | B,C | Evidence: file:1, sym:2

- [x] **CF-357** -- Bloom Filter Seeds Never Rotated
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-360** -- cert_verify.c parse_san_extension -- error code not propagated
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-368** -- Decoy Traffic Uses Easily Fingerprinted All-Zero Padding
  - S2 | B,C | Evidence: file:1, sym:1

- [x] **CF-369** -- Diag/Tracepoints Initialize in init_net
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-378** -- Hardcoded 8-Byte CID in Short Header Unprotect
  - S2 | B,C | Evidence: file:1, sym:1

- [x] **CF-380** -- Hostname Wildcard Matching Allows Wildcards in Non-Leftmost Position
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-397** -- Netlink PM Commands Missing CAP_NET_ADMIN Checks
  - S2 | B,C | Evidence: file:1, sym:2

- [x] **CF-398** -- No Flow Count Limit in HTTP Datagram Manager
  - S2 | B,C | Evidence: file:1, sym:1

- [x] **CF-399** -- No Token Replay Protection Beyond Timestamp
  - S2 | B,C | Evidence: file:1, sym:1

- [x] **CF-402** -- Path Length Constraint Check Off-By-One
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-408** -- Proc Entries Hardcoded to init_net.proc_net
  - S2 | B,C | Evidence: file:3, snippet:2

- [x] **CF-412** -- Retry Token Address Validation Uses Weak Hash
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-415** -- Security Hardening MIB Stats Always Go to init_net
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-420** -- Stateless Reset Static Key Accessible via `tquic_stateless_reset_get_static_key()` Export
  - S2 | B,C | Evidence: file:1, sym:2, snippet:1

- [x] **CF-422** -- Sysctl Permissions Are Overly Permissive
  - S2 | B,C | Evidence: file:1, sym:1

- [x] **CF-424** -- Token Hash Comparison Not Constant-Time
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-425** -- Token Key Rotation Does Not Zeroize Old Key
  - S2 | B,C | Evidence: file:1, sym:3, snippet:2

- [x] **CF-440** -- asn1_get_length Does Not Handle Length 0x84+
  - S2 | B | Evidence: file:1, lines:2, snippet:1

- [x] **CF-455** -- 0-RTT Encrypt Allocates AEAD Per-Packet
  - S2 | B | Evidence: file:1, snippet:1

- [x] **CF-460** -- AMP-3: The MASQUE CONNECT-UDP tunnel implementation in `masque/connect_udp.c` creates UDP sockets to
  - S2 | B | Evidence: file:1, lines:1

- [x] **CF-475** -- MEM-1: `tquic_handshake.c` lines 605 and 1136 allocate skbs based on computed handshake message leng
  - S2 | B | Evidence: file:1, sym:1, lines:5

- [x] **CF-499** -- XDP Uses capable
  - S2 | B | Evidence: file:1, snippet:1

- [x] **CF-521** -- `tquic_hs_cleanup` -- does not zeroize exporter_secret and resumption_secret
  - S3 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-522** -- `tquic_hs_generate_client_hello` -- client random not checked for all-zero
  - S3 | B,C | Evidence: file:1, sym:2

- [x] **CF-523** -- `tquic_hs_get_handshake_secrets` and `tquic_hs_get_app_secrets` -- no output buffer size validation
  - S3 | B,C | Evidence: file:1, sym:2

- [x] **CF-524** -- `tquic_hs_process_certificate_verify` hardcodes "server CertificateVerify" string
  - S3 | B,C | Evidence: file:1, sym:1

- [x] **CF-525** -- `tquic_hs_process_new_session_ticket` -- ignores extensions
  - S3 | B,C | Evidence: file:1, sym:5, lines:5

- [x] **CF-535** -- Constant-Time Comparison Used for Integrity Tags
  - S3 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-541** -- HMAC Output Not Zeroized on Fallback Path
  - S3 | B,C | Evidence: file:1, snippet:1

- [x] **CF-542** -- Inconsistent Error Return From verify_chain
  - S3 | B,C | Evidence: file:1, lines:1

- [x] **CF-547** -- memzero_explicit Used Correctly for Key Material
  - S3 | B,C | Evidence: sym:2, lines:2

- [x] **CF-555** -- parse_basic_constraints Hardcoded BOOLEAN Length
  - S3 | B,C | Evidence: file:1, snippet:1

- [x] **CF-560** -- SAN Parsing Capacity Limit Check Could Be Tighter
  - S3 | B,C | Evidence: file:1, snippet:1

- [x] **CF-562** -- server_ticket_key Is Static Global Without Rotation
  - S3 | B,C | Evidence: file:1, snippet:1

- [x] **CF-590** -- `tquic_stateless_reset_detect()` Iterates All Tokens Non-Constant-Time
  - S3 | B | Evidence: file:1, sym:2, snippet:1

- [x] **CF-598** -- CPU-6: The QPACK decoder accepts a `max_table_capacity` parameter from the peer via SETTINGS. While 
  - S3 | B | Evidence: file:1, sym:2, snippet:1

- [x] **CF-603** -- MEM-3: The NF connection tracking limit (65536) has no per-source-IP limit at the netfilter layer. W
  - S3 | B | Evidence: file:1, sym:3, lines:2

- [x] **CF-606** -- Multicast Group Only Requires CAP_NET_ADMIN
  - S3 | B | Evidence: sym:2, lines:5, snippet:1

- [x] **CF-622** -- Stream Creation Not Bounded in Input Path
  - S3 | B | Evidence: sym:2, lines:2, snippet:1

- [x] **CF-631** -- tquic_process_coalesced Missing Infinite Loop Guard
  - S3 | B | Evidence: file:1, sym:2, lines:2

#### Concurrency (45)

- [x] **CF-330** -- `additional_addr_add()` Has TOCTOU Between Duplicate Check and Insert
  - S2 | B,C | Evidence: file:1, sym:2, lines:2

- [x] **CF-336** -- `tquic_accept()` Holding `sk_lock.slock` Improperly
  - S2 | B,C | Evidence: file:1, sym:3

- [x] **CF-338** -- `tquic_fc_conn_data_sent()` Race Between Check and Update
  - S2 | B,C | Evidence: file:1, sym:3

- [x] **CF-343** -- `tquic_hs_process_server_hello` -- `static const` inside function body
  - S2 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-344** -- `tquic_migrate_validate_all_additional()` Lock Drop/Reacquire Pattern
  - S2 | B,C | Evidence: file:1, sym:2, snippet:2

- [x] **CF-355** -- atomic_inc/dec for rx_queue_len on every enqueue/dequeue
  - S2 | A,B | Evidence: file:2, sym:4

- [x] **CF-364** -- connect_ip.c Datagram Buffer Allocation from Attacker Data
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-379** -- HMAC Transform Allocated Per-Token in `tquic_stateless_reset_generate_token()`
  - S2 | B,C | Evidence: file:1, sym:4

- [x] **CF-386** -- Load Balancer Nonce Counter Wraps Without Re-keying
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-394** -- Multiple atomic operations in NAPI enqueue path
  - S2 | A,B | Evidence: file:2, sym:4

- [x] **CF-395** -- NAT Keepalive Config Pointer Not Protected Against Concurrent Free
  - S2 | B,C | Evidence: file:1, sym:2, snippet:1

- [x] **CF-407** -- poll() Accesses Connection/Stream Without Any Lock
  - S2 | B,C | Evidence: file:1, sym:1, snippet:2

- [x] **CF-414** -- Scheduler Change Race Between State Check and Modification
  - S2 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-418** -- smartnic.c - kmalloc_array with Attacker-Influenced Count
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-429** -- tquic_handshake.c tquic_start_handshake -- hs freed with memzero_explicit but no kfree_sensitive
  - S2 | B,C | Evidence: file:1, sym:3, snippet:1

- [x] **CF-430** -- tquic_output_flush -- spin_unlock_bh after acquiring spin_lock_bh, but lock dropped mid-loop
  - S2 | B,C | Evidence: file:1, sym:2, snippet:1

- [x] **CF-431** -- tquic_retry.c -- integrity_aead_lock held across AEAD operations
  - S2 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-434** -- tquic_stream_write Holds mgr->lock for Entire Copy Loop
  - S2 | B,C | Evidence: file:1, sym:1

- [x] **CF-435** -- Unbounded Pending Path Challenges
  - S2 | B,C | Evidence: file:1, sym:3, snippet:1

- [x] **CF-439** -- AMP-1: The anti-amplification check uses `atomic64` operations for `bytes_received` and `bytes_sent`
  - S2 | B | Evidence: file:1, lines:1, snippet:3

- [x] **CF-442** -- conn->data_sent Underflow on Error Path
  - S2 | B | Evidence: file:1, lines:4, snippet:1

- [x] **CF-443** -- CPU-2: FEC decoder block search is a linear list walk.
  - S2 | B | Evidence: file:1, lines:1, snippet:1

- [x] **CF-444** -- EDF Scheduler edf_select_path Called Without Lock
  - S2 | B | Evidence: file:1, sym:2, lines:3, snippet:1

- [x] **CF-450** -- tquic_recv_datagram Can Loop Forever Under Signal Pressure
  - S2 | B | Evidence: file:1, sym:1, lines:1, snippet:1

- [x] **CF-451** -- TQUIC_SCHEDULER Race on tquic_sched_find
  - S2 | B | Evidence: file:1, sym:6, lines:4, snippet:1

- [x] **CF-461** -- Anti-Amplification Check Has TOCTOU Race
  - S2 | B | Evidence: file:1, sym:2, snippet:1

- [x] **CF-465** -- Division Safety in Congestion Data Validation
  - S2 | B | Evidence: file:1, sym:1, snippet:1

- [x] **CF-476** -- Nested Locking in Repair Reception
  - S2 | B | Evidence: file:1, sym:1, snippet:1

- [x] **CF-477** -- Path Creation Uses static atomic_t for path_id -- Not Per-Connection
  - S2 | B | Evidence: file:1, sym:1, snippet:1

- [x] **CF-526** -- `tquic_server_check_path_recovery()` Uses `goto restart` Pattern
  - S3 | B,C | Evidence: file:1, sym:3

- [x] **CF-529** -- AF_XDP frame pool uses spinlock for every frame alloc/free
  - S3 | A,B | Evidence: file:2, sym:1, lines:1

- [x] **CF-532** -- CID Table Initialization Not Thread-Safe
  - S3 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-537** -- CRYPTO_TFM_REQ_MAY_BACKLOG in Atomic Context
  - S3 | B,C | Evidence: file:1, sym:3, snippet:1

- [x] **CF-544** -- Lock Drop/Re-acquire Pattern in Key Derivation
  - S3 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-550** -- Missing lockdep Annotations
  - S3 | B,C | Evidence: sym:3, snippet:1

- [x] **CF-556** -- Path Validation Response Queue Uses Two Tracking Mechanisms
  - S3 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-561** -- Scheduler Lock Uses spin_lock Without _bh
  - S3 | B,C | Evidence: file:1, sym:1

- [x] **CF-568** -- tquic_output_flush Holds conn->lock While Calling GFP_ATOMIC Allocation
  - S3 | B,C | Evidence: file:1, sym:7, lines:5

- [x] **CF-573** -- tquic_timer_state_free -- thorough and correct
  - S3 | B,C | Evidence: file:1, sym:2

- [x] **CF-580** -- CPU-3: CID pool active count enumeration.
  - S3 | B | Evidence: file:1, sym:1, lines:1, snippet:1

- [x] **CF-581** -- spin_lock
  - S3 | B | Evidence: file:1, lines:2, snippet:1

- [x] **CF-583** -- tquic_gso_init Integer Overflow in Allocation Size
  - S3 | B | Evidence: file:1, sym:1, lines:1, snippet:2

- [x] **CF-601** -- Failover Sent Packet Count Can Go Negative
  - S3 | B | Evidence: file:1, sym:1, snippet:1

- [x] **CF-612** -- Priority Extension Allocation Race
  - S3 | B | Evidence: file:1, snippet:1

- [x] **CF-636** -- tquic_stream_set_priority Missing Lock Protection
  - S3 | B | Evidence: file:1, sym:2, snippet:1

#### Correctness (77)

- [x] **CF-331** -- `bbrv3.c` CE Ratio Potential Division by Zero
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-333** -- `http3_frame.c` Settings Frame Parser: No Bounds on `count`
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-334** -- `kmem_cache_create()` Per Stream Manager Risks Name Collision
  - S2 | B,C | Evidence: file:1, sym:2

- [x] **CF-337** -- `tquic_cong.c` ECN Byte Calculation Overflow
  - S2 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-345** -- `tquic_nl_cmd_path_dump()` Incorrect Cast of `cb->ctx`
  - S2 | B,C | Evidence: file:1, sym:4, snippet:1

- [x] **CF-346** -- `tquic_path_compute_score()` Integer Overflow in Score Calculation
  - S2 | B,C | Evidence: file:1, sym:2, snippet:1

- [x] **CF-347** -- `tquic_path_is_degraded()` Division by Zero Possible
  - S2 | B,C | Evidence: file:1, sym:2, snippet:1

- [x] **CF-349** -- `tquic_process_stream_frame()` Does Not Check Final Size Consistency
  - S2 | B,C | Evidence: file:1, sym:2, snippet:1

- [x] **CF-350** -- `tquic_sendmsg_datagram()` Allocates Kernel Buffer Sized by User-Controlled `len`
  - S2 | B,C | Evidence: file:1, sym:2, snippet:1

- [x] **CF-356** -- Benchmark write() Handler - Stack Buffer for User Input
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-358** -- BPM Path Manager Uses Workqueue Without Connection Lifetime Guard
  - S2 | B,C | Evidence: file:1, sym:5, snippet:1

- [x] **CF-359** -- cert_verify.c - kmalloc(count + 1) Integer Overflow
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-365** -- connect_udp.c URL Encoding Can Exceed Buffer
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-366** -- Connection State Not Checked in tquic_conn_handle_close
  - S2 | B,C | Evidence: file:1, sym:2, snippet:1

- [x] **CF-375** -- Gaussian Random Approximation Produces Biased Distribution
  - S2 | B,C | Evidence: file:1, sym:3

- [x] **CF-376** -- h3_stream_recv_data frame_hdr Buffer Partial Read
  - S2 | B,C | Evidence: file:1, sym:3, snippet:1

- [x] **CF-377** -- h3_stream_recv_headers Does Not Validate payload_len Against H3_MAX_FRAME_PAYLOAD_SIZE
  - S2 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-381** -- http3_priority.c snprintf Priority Field Truncation
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-384** -- kmem_cache Names Not Unique Per Connection
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-388** -- MEDIUM: kzalloc per io_uring async request
  - S2 | A,B | Evidence: file:2, sym:4, snippet:2

- [x] **CF-401** -- Packet Number Decode Returns 0 on Invalid Input
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-403** -- Path Manager netdev_event Shadows Variable 'i'
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-411** -- Request ID Truncation from u64 to int
  - S2 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-416** -- Signed/Unsigned Mismatch in Scheduler Queue Delay
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-419** -- snprintf Return Value Not Checked in qlog.c
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-423** -- Sysctl Variables Lack Range Validation
  - S2 | B,C | Evidence: file:1, snippet:2

- [x] **CF-426** -- tquic_cid_pool_init -- timer initialized but not cancelled on later failure
  - S2 | B,C | Evidence: file:1, sym:6, snippet:2

- [x] **CF-428** -- tquic_fc_reserve_credit Does Not Actually Reserve
  - S2 | B,C | Evidence: file:1, sym:1, snippet:2

- [x] **CF-432** -- tquic_stream_memory_pressure Frees Without ext Cleanup
  - S2 | B,C | Evidence: file:1, sym:2, snippet:1

- [x] **CF-433** -- tquic_stream_trigger_output Inflight Underflow
  - S2 | B,C | Evidence: file:1, sym:2, snippet:1

- [x] **CF-436** -- Version Negotiation Packet Not Authenticated
  - S2 | B,C | Evidence: file:1, snippet:1

- [x] **CF-441** -- Coalesced Packet Processing Silently Truncates on Overflow
  - S2 | B | Evidence: file:1, lines:1, snippet:2

- [x] **CF-445** -- ktime_get_ts64 Written to skb->cb May Exceed cb Size
  - S2 | B | Evidence: file:1, sym:2, lines:2, snippet:1

- [x] **CF-446** -- MP Frame Type Range Check Too Broad
  - S2 | B | Evidence: file:1, lines:4, snippet:1

- [x] **CF-447** -- tquic_fc_stream_can_send Missing Overflow Check
  - S2 | B | Evidence: file:1, sym:1, lines:1, snippet:2

- [x] **CF-448** -- TQUIC_IDLE_TIMEOUT Missing Range Validation
  - S2 | B | Evidence: file:1, lines:1, snippet:1

- [x] **CF-453** -- Version Negotiation Versions Logged Without Rate Limiting
  - S2 | B | Evidence: file:1, sym:1, lines:1, snippet:1

- [x] **CF-458** -- Alpha Precision Loss in Coupled CC
  - S2 | B | Evidence: file:1, sym:2, snippet:1

- [x] **CF-464** -- Deadline Scheduler in_flight Underflow
  - S2 | B | Evidence: file:1, lines:1

- [x] **CF-468** -- h3_parse_settings_frame u64 to Pointer Cast
  - S2 | B | Evidence: file:1, sym:1, snippet:1

- [x] **CF-471** -- In-Flight Calculation Signed Arithmetic
  - S2 | B | Evidence: file:1, sym:1, snippet:1

- [x] **CF-474** -- Loss Rate Cast Overflow
  - S2 | B | Evidence: file:1, sym:1, snippet:2

- [x] **CF-481** -- Reorder Buffer Sequence in skb->cb Alignment
  - S2 | B | Evidence: file:1, sym:5, snippet:1

- [x] **CF-482** -- sched/scheduler.c Debug Logging Leaks Kernel Pointers
  - S2 | B | Evidence: file:1, sym:4, snippet:1

- [x] **CF-484** -- Sort Modifies Caller's Lost Packets Array
  - S2 | B | Evidence: file:1, sym:2, snippet:1

- [x] **CF-516** -- `established_time` Set Twice in Connection State Machine
  - S3 | B,C | Evidence: file:1, sym:1

- [x] **CF-517** -- `sk->sk_err = -ret` Stores Negative Error Code
  - S3 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-518** -- `tquic_cid_compare()` Marked `__maybe_unused`
  - S3 | B,C | Evidence: file:1, sym:1

- [x] **CF-519** -- `tquic_cid_retire()` Sends RETIRE_CONNECTION_ID After Retirement
  - S3 | B,C | Evidence: file:1, sym:11, lines:1

- [x] **CF-520** -- `tquic_debug.c` CID Hex Loop Bound
  - S3 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-527** -- `tquic_store_session_ticket()` Does Not Store ALPN or Transport Parameters
  - S3 | B,C | Evidence: file:1, sym:3, snippet:1

- [x] **CF-528** -- `tquic_sysctl_prefer_v2()` Function Not Declared in Visible Header
  - S3 | B,C | Evidence: file:1, sym:1

- [x] **CF-530** -- bench/benchmark.c -- kvmalloc used correctly with kvfree
  - S3 | B,C | Evidence: file:2, sym:2, lines:2

- [x] **CF-533** -- close_work Repurposes drain_work for Retransmit Scheduling
  - S3 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-536** -- Context Set Level Does Not Check init Return Values
  - S3 | B,C | Evidence: file:1, sym:7, snippet:1

- [x] **CF-540** -- h3_varint_len Defined Multiple Times as Static
  - S3 | B,C | Evidence: file:1, sym:1

- [x] **CF-545** -- LOW: pacing_calc_gap uses division
  - S3 | A,B | Evidence: file:2, sym:1, snippet:1

- [x] **CF-546** -- LOW: Prague RTT scaling division on every ACK
  - S3 | A,B | Evidence: file:2, snippet:1

- [x] **CF-554** -- nla_put Operations in Netlink Properly Handle Failure
  - S3 | B,C | Evidence: file:1, sym:1

- [x] **CF-557** -- quic_exfil.c Decoy Packet Size Controlled by MTU
  - S3 | B,C | Evidence: file:1, sym:1, snippet:1

- [x] **CF-563** -- Slab Cache Names Are Not Module-Prefixed
  - S3 | B,C | Evidence: file:1, sym:2

- [x] **CF-565** -- tquic_conn_destroy -- thorough cleanup
  - S3 | B,C | Evidence: file:1, sym:2

- [x] **CF-567** -- tquic_main.c init -- correct cascading cleanup
  - S3 | B,C | Evidence: file:1, sym:2, lines:1

- [x] **CF-569** -- tquic_pacing_cleanup -- correct ordering
  - S3 | B,C | Evidence: file:1, sym:2, snippet:1

- [x] **CF-570** -- tquic_retry_rate_limit Potential Token Bucket Underflow
  - S3 | B,C | Evidence: file:1, sym:2, snippet:1

- [x] **CF-571** -- tquic_stream_manager_destroy Does Not Free Extended State for All Streams
  - S3 | B,C | Evidence: file:22, sym:4

- [x] **CF-572** -- tquic_timer_state_alloc -- cleanup loop is correct
  - S3 | B,C | Evidence: file:1, sym:2

- [x] **CF-574** -- Version Negotiation First Byte Missing Fixed Bit Randomization
  - S3 | B,C | Evidence: file:1, sym:1, lines:1

- [x] **CF-577** -- Workqueue Not Validated Before Use
  - S3 | B,C | Evidence: file:1, sym:4

- [x] **CF-589** -- `tquic_sock_listen()` Redundant `INIT_LIST_HEAD` Check
  - S3 | B | Evidence: file:1, sym:2, snippet:1

- [x] **CF-593** -- BPM Path Metrics min_rtt Initialized to UINT_MAX
  - S3 | B | Evidence: file:1, sym:1, snippet:1

- [x] **CF-608** -- Multiple Varint Implementations
  - S3 | B | Evidence: file:10, sym:2, lines:5

- [x] **CF-609** -- Netlink Attribute Policy Does Not Use Strict Validation for Binary Addresses
  - S3 | B | Evidence: file:1, sym:6, snippet:1

- [x] **CF-623** -- timer_setup with NULL Callback
  - S3 | B | Evidence: file:1, lines:1

- [x] **CF-626** -- tquic_encode_varint Does Not Validate val Range
  - S3 | B | Evidence: file:1, sym:2, lines:1

- [x] **CF-629** -- tquic_process_ack_frame Does Not Validate largest_ack vs first_ack_range
  - S3 | B | Evidence: file:1, sym:2, lines:1

- [x] **CF-635** -- tquic_stream_release Missing Error Return
  - S3 | B | Evidence: file:1, sym:2, lines:1

#### Api (3)

- [x] **CF-389** -- MEDIUM: Per-chunk skb allocation in zerocopy path
  - S2 | A,B | Evidence: file:2, sym:6, snippet:1

- [x] **CF-393** -- Missing skb->dev Assignment in Packet Injection
  - S2 | B,C | Evidence: file:1, sym:2, snippet:1

- [x] **CF-487** -- tquic_main.c init/exit -- conditional cleanup mismatch for NAPI/io_uring
  - S2 | B | Evidence: file:1, sym:6, snippet:1

#### Perf (4)

- [x] **CF-387** -- MEDIUM: BBRv3 uses ktime_get_ns() for every bandwidth sample
  - S2 | A,B | Evidence: file:2, sym:3, snippet:1

- [x] **CF-390** -- MEDIUM: Zerocopy sendmsg chunks at 1200 bytes
  - S2 | A,B | Evidence: file:2, sym:6, snippet:1

- [x] **CF-391** -- MIB counter updates on every packet in RX/TX paths
  - S2 | A,B | Evidence: sym:8, lines:2, snippet:1

- [x] **CF-579** -- `bench_latency.c` Allocation Without Overflow Check
  - S3 | B | Evidence: file:2, sym:1, lines:4, snippet:3

#### Build (1)

- [x] **CF-582** -- tquic_build_short_header_internal Writes pkt_num to buf+64 Scratch Space
  - S3 | B | Evidence: file:1, sym:2, lines:4, snippet:2

#### Tests (1)

- [x] **CF-585** -- `bench_common.c` Variance Calculation
  - S3 | B | Evidence: file:1, snippet:1
...
- [x] **CF-108** -- Missing Bounds Check Before Frame Type Read
  - S0 | B | Evidence: lines:2, snippet:1

- [x] **CF-121** -- RX parsing/decryption assumes contiguous skb data (non-linear skb / GRO risk)
  - S0 | A | Evidence: file:1, sym:2

- [x] **CF-130** -- Use-After-Free in `tquic_migrate_auto()` -- RCU-Protected Path Used After RCU Unlock
  - S0 | B | Evidence: file:1, sym:6

- [x] **CF-437** -- WebTransport Session Refcount Not Checked After Accept
  - S2 | B,C | Evidence: file:1

- [x] **CF-469** -- h3_parser_advance Missing Bounds Check
  - S2 | B | Evidence: file:1, sym:1

- [x] **CF-575** -- Version Negotiation Packet Size Not Validated Against 256-Byte Buffer
  - S3 | B,C | Evidence: file:1

- [x] **CF-614** -- Repair Data Pointer Lifetime
  - S3 | B | Evidence: file:2, sym:1

- [x] **CF-633** -- tquic_sched_release Frees ext Under Lock but kfree Can Sleep
  - S3 | B | Evidence: file:1, sym:1

#### Security (21)

- [x] **CF-093** -- Client Certificate Verification Uses Server Logic (EKU Bypass)
  - S0 | C | Evidence: sym:1, snippet:1

- [x] **CF-204** -- MASQUE Proxy Has No Access Control
  - S1 | B,C | Evidence: file:1

- [x] **CF-219** -- Retry Integrity Tag Uses Wrong Key/Nonce for QUIC v2
  - S1 | B,C | Evidence: file:1

- [x] **CF-259** -- 0-RTT Keys Derived With Empty Transcript
  - S1 | B | Evidence: file:1

- [x] **CF-260** -- 0-RTT Keys Derived With Empty Transcript (Not ClientHello Hash)
  - S1 | C | Evidence: sym:2

- [x] **CF-278** -- Memory Exhaustion via Unbounded QPACK Header Lists
  - S1 | B | Evidence: file:1, sym:1

- [x] **CF-456** -- 0-RTT Encrypt Allocates AEAD Per-Packet (Performance / Side Channel)
  - S2 | C | Evidence: sym:1, snippet:1

- [x] **CF-459** -- AMP-2: The `tquic_path_handle_challenge` function in `pm/path_validation.c:249` does not check anti-
  - S2 | B | Evidence: file:1, sym:2

- [x] **CF-462** -- asn1_get_length Does Not Handle Length 0x84+ (4+ byte lengths)
  - S2 | C | Evidence: snippet:1

- [x] **CF-485** -- STATE-1: The transition to "attack mode" (TQUIC_RL_COOKIE_REQUIRED) appears to be reactive -- it tri
  - S2 | B | Evidence: file:2

- [x] **CF-509** -- Netlink Events Do Not Include Timestamp
  - S3 | A,B,C | Evidence: file:1

- [x] **CF-534** -- Consistent use of kfree_sensitive for key material -- GOOD
  - S3 | B,C | Evidence: sym:1

- [x] **CF-539** -- Empty Hash Computed Without Algorithm Validation
  - S3 | B,C | Evidence: file:1

- [x] **CF-595** -- Constant-Time Comparison
  - S3 | B | Evidence: file:1, sym:1

- [x] **CF-602** -- INFO-1: Several `pr_debug`/`tquic_dbg` calls include connection state information. While these are c
  - S3 | B | Evidence: sym:3, snippet:1

- [x] **CF-604** -- MEM-4: While stream count is limited, each stream allocates both `send_buf` and `recv_buf` skb queue
  - S3 | B | Evidence: file:1, sym:1

- [x] **CF-613** -- PROTO-1: The retire loop at `tquic_cid.c:667-674` iterates the entire remote CID list for each NEW_C
  - S3 | B | Evidence: sym:1

- [x] **CF-616** -- Sensitive Key Cleanup
  - S3 | B | Evidence: file:1, sym:1

- [x] **CF-619** -- STATE-2: An attacker could open connections, complete the handshake (consuming 1 connection per clie
  - S3 | B | Evidence: file:1

- [x] **CF-620** -- STATE-3: No visible limit on the number of paths per connection. If an attacker can trigger path cre
  - S3 | B | Evidence: lines:2, snippet:1

- [x] **CF-621** -- Stateless Reset Token Comparison Timing
...
- [x] **CF-091** -- Attacker-Controlled Allocation Sizes
  - S0 | B | Evidence: lines:1

- [x] **CF-105** -- List Iterator Invalidation in BPM Netdev Notifier (Drop-Relock Pattern)
  - S0 | C | Evidence: sym:2, snippet:1

- [x] **CF-124** -- TOCTOU Race in Failover Hysteresis (Atomic Read-Modify-Write)
  - S0 | C | Evidence: sym:2, snippet:3

- [x] **CF-264** -- Aggregate Scheduler Unfair Minimum Weight Floor
  - S1 | B | Evidence: file:1

- [x] **CF-273** -- h3_request_send_headers State Check TOCTOU
  - S1 | B | Evidence: file:1, sym:1

- [x] **CF-291** -- Stale Path Pointer Returned After rcu_read_unlock
  - S1 | B | Evidence: sym:4

- [x] **CF-293** -- TOCTOU in Round-Robin Path Count vs Selection
  - S1 | B | Evidence: file:1

- [x] **CF-304** -- Unit tests model packet-number length as readable from the first byte without HP removal
  - S1 | A | Evidence: file:1, sym:5

- [x] **CF-308** -- Weighted Scheduler Has No Lock Protection
  - S1 | B | Evidence: file:1, sym:1

- [x] **CF-329** -- WebTransport: TOCTOU in Datagram Queue Push
  - S2 | A,B,C | Evidence: file:1

- [x] **CF-354** -- Anti-Replay Hash Table Cleanup Iterates All Buckets Under spinlock
  - S2 | B,C | Evidence: file:1

- [x] **CF-466** -- Duplicate ECF Path State Allocation Race
  - S2 | B | Evidence: file:1

- [x] **CF-473** -- Lock Ordering Between Encoder and Scheduler
  - S2 | B | Evidence: file:1, sym:1

- [x] **CF-478** -- Path Manager discover_addresses Holds rtnl_lock While Accessing inet6_dev
  - S2 | B | Evidence: file:1, sym:1

- [x] **CF-480** -- Push Entry Count O(n) Iteration
  - S2 | B | Evidence: file:1

- [x] **CF-497** -- WebTransport Datagram Queue Double-Checked Locking Anti-Pattern
  - S2 | B | Evidence: file:1

- [x] **CF-578** -- XOR FEC encoding is efficient
  - S3 | A,B | Evidence: sym:1

- [x] **CF-588** -- `tquic_accept()` Nested Locking Pattern
  - S3 | B | Evidence: file:1, sym:2

- [x] **CF-591** -- Aggregate Scheduler Long Spinlock Hold
  - S3 | B | Evidence: file:1, sym:1

- [x] **CF-594** -- C99 Variable Declaration in Loop
  - S3 | B | Evidence: file:1, sym:1

- [x] **CF-599** -- CROSS-2: Consider using the `tquic_rx_buf_cache` slab cache pattern (already used at `tquic_input.c:
  - S3 | B | Evidence: file:1, sym:2

- [x] **CF-605** -- Missing Documentation on Lock Ordering
  - S3 | B | Evidence: file:2, sym:1

- [x] **CF-607** -- Multiple Scheduler Registration Systems Coexist
  - S3 | B | Evidence: sym:4

- [x] **CF-611** -- Path Validation Timer del_timer vs del_timer_sync
  - S3 | B | Evidence: file:1, sym:2

- [x] **CF-634** -- tquic_stream_alloc Uses GFP_KERNEL in Potentially Atomic Context
  - S3 | B | Evidence: file:1, sym:2

#### Correctness (17)

- [x] **CF-111** -- Potential Integer Overflow in CRYPTO Frame on 32-bit
  - S0 | B | Evidence: lines:1, snippet:1

- [x] **CF-117** -- Reason Length Underflow on 32-bit
  - S0 | B | Evidence: lines:1, snippet:1

- [x] **CF-277** -- Large Stack Allocation in XOR Recovery
  - S1 | B | Evidence: file:1, sym:1

- [x] **CF-290** -- sched/scheduler.c wrr_select Stale total_weight
  - S1 | B | Evidence: file:1

- [x] **CF-406** -- Per-path stats updated from both RX and TX
  - S2 | A,B | Evidence: sym:2

- [x] **CF-457** -- All MP Scheduler init() Functions Silently Fail on OOM
  - S2 | B | Evidence: sym:8

- [x] **CF-467** -- ECN State Tracking Per-Round Limitation
  - S2 | B | Evidence: file:1, sym:1

- [x] **CF-483** -- sched/scheduler.c ECF Loss Rate Division by Zero
  - S2 | B | Evidence: file:1

- [x] **CF-490** -- Triplicated Varint Encode/Decode Implementations
  - S2 | B | Evidence: file:3

- [x] **CF-498** -- Weighted Scheduler Weight Not Validated
  - S2 | B | Evidence: file:1

- [x] **CF-505** -- HTTP/3 Priority: push_buckets Not Initialized
  - S3 | A,B,C | Evidence: file:1

- [x] **CF-543** -- io_uring.c getsockopt Same len Validation Pattern
  - S3 | B,C | Evidence: file:1

- [x] **CF-549** -- Missing Error Check for init_net Reference
  - S3 | B,C | Evidence: sym:1

- [x] **CF-552** -- Multiple Redundant Varint Implementations
  - S3 | B,C | Evidence: sym:2

- [x] **CF-600** -- Debug Logging of Packet Contents
  - S3 | B | Evidence: sym:1

- [x] **CF-610** -- No Per-Connection Frame Processing Budget
  - S3 | B | Evidence: sym:1

- [x] **CF-617** -- settings seen_mask Limited to 64 Settings
  - S3 | B | Evidence: file:1

#### Api (3)

- [x] **CF-261** -- `setsockopt(SOL_TQUIC, ...)` forces `optlen >= sizeof(int)` even for string/binary options
  - S1 | A | Evidence: file:1, sym:4

- [x] **CF-479** -- Priority State No Limit on stream_count
  - S2 | B | Evidence: file:1

- [x] **CF-596** -- Coupled CC Alpha Smoothing May Suppress Rapid Changes
  - S3 | B | Evidence: file:1, sym:1

#### Perf (4)

- [x] **CF-275** -- HIGH: Multiple ktime_get() calls per packet
  - S1 | A | Evidence: file:3, sym:3

- [x] **CF-282** -- Multiple ktime_get() calls per packet
  - S1 | B | Evidence: file:3, sym:3

- [x] **CF-288** -- Same Stack Issue in Encoder
  - S1 | B | Evidence: file:1, sym:2

- [x] **CF-637** -- Weighted DRR Iterates Over Empty Slots
  - S3 | B | Evidence: file:1

#### Tests (1)

- [x] **CF-382** -- Interop Framework - Same Pattern
  - S2 | B,C | Evidence: file:1

#### Other (36)

- [x] **CF-087** -- (actual): `tquic_hs_process_server_hello` -- missing check before cipher suite read
  - S0 | C | Evidence: sym:1, snippet:1

- [x] **CF-088** -- (Revised): tquic_process_packet Does Not Validate pkt_num_len Against Remaining Data (tquic_input.c,
  - S0 | C | Evidence: sym:2, snippet:2

- [x] **CF-090** -- AF_XDP Socket and Device Lookup Use init_net (Container Escape)
  - S0 | C | Evidence: sym:2, snippet:1

- [x] **CF-094** -- conn->sk Accessed Without Lock After Stateless Reset (tquic_input.c, lines 397-407)
  - S0 | C | Evidence: sym:1, snippet:1

- [x] **CF-103** -- IPv4/IPv6 Address Discovery Enumerates Host Interfaces (Container Escape / Info Leak)
  - S0 | C | Evidence: snippet:2

- [x] **CF-107** -- MASQUE CONNECT-UDP Proxy Creates Sockets in init_net (Container Escape)
  - S0 | C | Evidence: snippet:1

- [x] **CF-109** -- Packet Number Length Extracted Before Header Unprotection (tquic_input.c, lines 2529, 2545 vs 2565)
  - S0 | C | Evidence: sym:2, snippet:2

- [x] **CF-114** -- QUIC-over-TCP Client and Server Sockets Use init_net (Container Escape)
  - S0 | C | Evidence: sym:1, snippet:1

- [x] **CF-116** -- Rate Calculation Integer Overflow (`count * 1000`)
  - S0 | C | Evidence: snippet:2

- [x] **CF-123** -- Stale skb->len Read After ip_local_out (tquic_output.c, lines 1730-1736)
  - S0 | C | Evidence: sym:2, snippet:2

- [x] **CF-126** -- Tunnel Socket Creation Uses init_net (Container Escape)
  - S0 | C | Evidence: snippet:1

- [x] **CF-133** -- Use-After-Free in Path Lookup (tquic_input.c, lines 245-261)
  - S0 | C | Evidence: sym:3, snippet:1

- [x] **CF-135** -- Wrong Network Namespace in ip_local_out (tquic_output.c, line 1730)
  - S0 | C | Evidence: sym:1, snippet:2

- [x] **CF-258** -- (Revised): tquic_pacing_work Accesses skb->len After tquic_output_packet (tquic_output.c, lines 1413
  - S1 | C | Evidence: sym:3, snippet:1

- [x] **CF-263** -- ACK Frame bytes_acked Calculation Can Overflow (tquic_input.c, lines 736-738)
  - S1 | C | Evidence: sym:1, snippet:1

- [x] **CF-281** -- Multipath Frame Processing Lacks Encryption Level Validation (tquic_input.c, lines 2027-2038)
  - S1 | C | Evidence: sym:2, snippet:2

- [x] **CF-296** -- tquic_output_packet Passes NULL conn to ip_local_out (tquic_output.c, line 1413)
  - S1 | C | Evidence: sym:3, snippet:2

- [x] **CF-300** -- tquic_udp_recv Processes Stateless Reset Before Authenticating Packet (tquic_input.c, lines 2916-293
  - S1 | C | Evidence: sym:2, snippet:1

- [x] **CF-463** -- Coalesced Packet Processing Silently Truncates on Overflow (tquic_input.c, lines 3172-3173)
  - S2 | C | Evidence: sym:1, snippet:2

- [x] **CF-472** -- ktime_get_ts64 Written to skb->cb May Exceed cb Size (tquic_input.c, line 1471)
  - S2 | C | Evidence: sym:1, snippet:1

- [x] **CF-486** -- tquic_gro_flush Drops and Re-acquires Lock Per Packet (tquic_input.c, lines 2303-2310)
  - S2 | C | Evidence: sym:2, snippet:1

- [x] **CF-488** -- tquic_main.c init/exit -- conditional cleanup mismatch for NAPI/io_uring
  - S2 | C | Evidence: sym:1, snippet:1

- [x] **CF-489** -- tquic_recv_datagram Can Loop Forever Under Signal Pressure (tquic_output.c, lines 2706-2743)
  - S2 | C | Evidence: sym:2, snippet:2

- [x] **CF-496** -- Version Negotiation Versions Logged Without Rate Limiting (tquic_input.c, lines 473-477)
  - S2 | C | Evidence: sym:1, snippet:1

- [x] **CF-500** -- XDP Uses capable() Instead of ns_capable()
  - S2 | C | Evidence: snippet:1

- [x] **CF-586** -- `bench_common.c` Variance Calculation (Userspace Code)
  - S3 | C | Evidence: snippet:1

- [x] **CF-587** -- `bench_latency.c` Allocation Without Overflow Check (Userspace Code)
  - S3 | C | Evidence: snippet:4

- [x] **CF-592** -- Benchmark Code: Userspace, Not Kernel
  - S3 | C | Evidence: file:1

- [x] **CF-615** -- send_skb Variable Used After Potential NULL
  - S3 | C | Evidence: snippet:1

- [x] **CF-618** -- spin_lock (Not spin_lock_bh) Used in tquic_process_max_data_frame (tquic_input.c, lines 1015-1017)
  - S3 | C | Evidence: sym:2, snippet:1

- [x] **CF-624** -- tquic_build_short_header_internal Writes pkt_num to buf+64 Scratch Space (tquic_output.c, line 818)
  - S3 | C | Evidence: sym:6, snippet:2

- [x] **CF-625** -- tquic_encap_recv Double UDP Header Strip
  - S3 | C | Evidence: sym:1

- [x] **CF-627** -- tquic_encode_varint Does Not Validate val Range (tquic_output.c, lines 164-198)
  - S3 | C | Evidence: sym:3

- [x] **CF-628** -- tquic_gso_init Integer Overflow in Allocation Size (tquic_output.c, line 1489)
  - S3 | C | Evidence: sym:2, snippet:2

- [x] **CF-630** -- tquic_process_ack_frame Does Not Validate largest_ack vs first_ack_range (tquic_input.c, lines 601-6
  - S3 | C | Evidence: sym:2

- [x] **CF-632** -- tquic_process_coalesced Missing Infinite Loop Guard (tquic_input.c, lines 3079-3182)
  - S3 | C | Evidence: sym:2
...
- [x] ~~**CF-454** -- CROSS-1: The systematic use of `jhash` with seed 0 across 15+ call sites creates a coordinated attac~~
  - S1 | B | Evidence: NONE

- [x] ~~**CF-597** -- Coupled CC Alpha Smoothing May Suppress Rapid Changes~~
  - S3 | C | Evidence: NONE

- [x] ~~**CF-638** -- ACK Frequency Frame Type Inconsistency~~
  - S3 | C | Evidence: NONE

- [x] ~~**CF-639** -- copy_from_sockptr in setsockopt Always Uses sizeof(type)~~
  - S3 | C | Evidence: NONE

- [x] ~~**CF-640** -- Diagnostic Counter Wraps~~
  - S3 | B | Evidence: NONE

- [x] ~~**CF-641** -- Error Codes Leak Processing State~~
  - S3 | B | Evidence: NONE

- [x] ~~**CF-642** -- IMMEDIATE_ACK Frame Type Similar Issue~~
  - S3 | C | Evidence: NONE

- [x] ~~**CF-643** -- Inconsistent Congestion State Layouts~~
  - S3 | C | Evidence: NONE

- [x] ~~**CF-644** -- Multiple Varint Implementations (Code Duplication Risk)~~
  - S3 | C | Evidence: NONE

- [x] ~~**CF-645** -- Three Parallel Scheduler Frameworks~~
  - S3 | C | Evidence: NONE
